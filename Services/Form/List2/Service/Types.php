...
class Types extends \Object\Form\Wrapper\List2 {
	public $form_link = 'ss_service_types_list';
	public $module_code = 'SS';
	public $title = 'S/S Service Types List';
	public $options = [
	...
	public $elements = [
		...
		'filter' => [
			'full_text_search' => [
				'full_text_search' => ['order' => 1, 'row_order' => 300, 'label_name' => 'Text Search', 'full_text_search_columns' => ['a.ss_servtype_code', 'a.ss_servtype_name'], 'placeholder' => true, 'domain' => 'name', 'percent' => 100, 'null' => true],
			]
		],
		'sort' => [
			'__sort' => [
	...
	public $query_primary_model = '\Numbers\Services\Services\Model\Service\Types';
	public $list_options = [
		'pagination_top' => '\Numbers\Frontend\HTML\Form\Renderers\HTML\Pagination\Base',
		'pagination_bottom' => '\Numbers\Frontend\HTML\Form\Renderers\HTML\Pagination\Base',
		'default_limit' => 30,
		'default_sort' => [
			'ss_servtype_order' => SORT_ASC
		]
	];
	const LIST_SORT_OPTIONS = [
		'ss_servtype_order' => ['name' => 'Order'],
		'ss_servtype_name' => ['name' => 'Name']
	];
}