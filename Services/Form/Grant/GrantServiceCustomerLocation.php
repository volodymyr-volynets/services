...
use Numbers\Services\Services\Model\Collection\ServiceCustomerLocation;
use Numbers\Services\Services\Model\Service\Organizations;
use Numbers\Users\Organizations\Model\Locations;
use Object\Content\Messages;
use Object\Form\Wrapper\Base;

class GrantServiceCustomerLocation extends Base
{
    ...
    public function validate(& $form)
    {
        ...
        if (empty($locations)) {
            $form->error(DANGER, Messages::NO_WHAT_FOUND, '', ['replace' => ['[what]' => i18n(null, 'Locations')]]);
            return;
        }
        $locations_fixed = [];
        ...
        foreach ($form->values['service_ids'] as $k => $v) {
            ...
            $service_organizaiton_result = Organizations::collectionStatic()->merge([
