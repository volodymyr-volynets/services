...
class MapAR extends \Object\ActiveRecord {
	 ...
	 */
	public ?int $ss_servchanmap_tenant_id = NULL;
	 ...
	 */
	public ?string $ss_servchanmap_timestamp = 'now()';
	 ...
	 */
	public ?int $ss_servchanmap_service_id = NULL;
	 ...
	 */
	public ?int $ss_servchanmap_channel_id = NULL;
	 ...
	 */
	public ?int $ss_servchanmap_inactive = 0;
}