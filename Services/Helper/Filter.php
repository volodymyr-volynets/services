...
class Filter {
	...
	const F_SERVSTATUS_CODE = [ 'label_name' => 'Status', 'domain' => 'group_code', 'null' => true, 'method' => 'multiselect', 'multiple_column' => 1, 'searchable' => true, 'tree' => true, 'options_model' => '\Numbers\Services\Services\DataSource\Statuses::optionsJsonSingle', 'options_options' => ['i18n' => 'skip_sorting']];
	// service
