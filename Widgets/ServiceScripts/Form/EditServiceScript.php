...
class EditServiceScript extends Base
{
    ...
    public function overrides(& $form)
    {
        ...
        if ($wg_ss_id) {
            ...
            if (!empty($temp['wg_ss_service_script_id'])) {
                ...
                Helper::renderQuestionRaw($form, $temp['wg_ss_service_script_id'], $temp['wg_ss_channel_id'], $temp['wg_ss_region_id'], $temp['wg_ss_language_code']);
            }
        }
    }
