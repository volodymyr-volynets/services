...
class Complaints extends \Object\Form\Wrapper\List2 {
	...
	public function renderCommentUser(& $form, & $options, & $value, & $neighbouring_values) {
		return \Numbers\Users\Users\Model\Users::getUsernameWithAvatar($neighbouring_values['wg_complaint_inserted_user_id']);
	}
