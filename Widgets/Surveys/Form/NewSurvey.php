...
class NewSurvey extends \Object\Form\Wrapper\Base {
	...
	public function overrides(& $form) {
		...
		if ($wg_survey_service_script_id && $wg_survey_channel_id && $wg_survey_region_id && $wg_survey_language_code) {
			\Numbers\Services\Services\Helper\ServiceScript\Helper::renderQuestionRaw($form, $wg_survey_service_script_id, $wg_survey_channel_id, $wg_survey_region_id, $wg_survey_language_code);
		}
	}
